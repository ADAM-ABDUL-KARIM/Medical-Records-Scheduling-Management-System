...
function ViewRecord({ Record, onDelete, onSave, isPatient }) {
  ...
  const handleSave = () => {
    const updatedRecord = {
      ...editedRecord,
      diagnosis: editedRecord.diagnosis.map((d) => ({
        diagnosis: d.diagnosis,
      })),
      medication: editedRecord.medication.map((m) => ({
  ...
  return (
    <div className="rec-container">
      ...
      <div
        className={`rec-details ${isExpanded ? "expanded" : ""}`}
        ref={detailsRef}
      >
        {isEditing ? (
          <>
          ...
          <>
            ...
            <p className="rec-content">
              <b>Diagnosis:</b>{" "}
              {Record.diagnosis.map((d) => d.diagnosis).join(", ")}
            </p>
            <p className="rec-content">
              <b>Medication:</b>{" "}
